        ...
        <table id="contenedor">
            <thead>
                ...
                <tr>
                    ...
                    <th id="nom_dato">Hombres</th>
                    <th id="nom_dato">Mujeres</th>
                    <th id="nom_dato">Total</th>
                    <th id="nom_dato">Año</th>
                    <?php ?>
                </tr>
            </thead>
            <tbody>
                <?php 
                $query="SELECT * FROM datos_casos";
                ...
                <tr>
                    ...
                    <td id="celda"><?php echo $fila['hombres'];?></td>
                    <td id="celda"><?php echo $fila['mujeres'];?></td>
                    <td id="celda"><?php echo $fila['total'];?></td>
                    <td id="celda"><?php echo $fila['año'];?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>    
